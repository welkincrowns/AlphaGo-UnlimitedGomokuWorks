...
def training(train_size, test_size, cv_size, training_batch_size, training_rate):
	...
	hidden_conv_layer7 = nn_layer(batch_size, hidden_conv_layer6, [3, 3, 24, 24], 24, 'conv_layer_7')
	hidden_conv_layer8 = nn_layer(batch_size, hidden_conv_layer7, [3, 3, 24, 24], 24, 'conv_layer_8')
	y = nn_layer(batch_size, hidden_conv_layer8, [1, 1, 24, 1], 1, 'output_layer', tf.nn.softmax, True)
